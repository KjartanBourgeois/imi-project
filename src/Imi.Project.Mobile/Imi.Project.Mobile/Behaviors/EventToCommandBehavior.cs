...
{
    public class EventToCommandBehavior : BindableBehavior<SfListView>
    {
        ...
        protected override void OnAttachedTo(SfListView visualElement)
        {
        ...
        protected override void OnDetachingFrom(SfListView view)
        {
            if (_handler != null)
